...
CREATE TABLE `recommendations` (`R_ID` int(10) NOT NULL AUTO_INCREMENT, `Book_Name` varchar(50) DEFAULT NULL, `Description` varchar(255) DEFAULT NULL, `UserId` varchar(50) DEFAULT NULL, PRIMARY KEY (`R_ID`), KEY `RollNo` (`UserId`), CONSTRAINT `recommendations_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserId`));
