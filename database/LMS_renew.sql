...
CREATE TABLE `renew` (`UserId` varchar(50) NOT NULL, `BookId` int(10) NOT NULL, PRIMARY KEY (`UserId`,`BookId`), KEY `BookId` (`BookId`), CONSTRAINT `renew_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `user` (`UserId`), CONSTRAINT `renew_ibfk_2` FOREIGN KEY (`BookId`) REFERENCES `book` (`BookId`));
