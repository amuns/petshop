        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <!--/.span3-->
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="book.php?uid=<?=$uId?>" method="post">
                        ...
                        <table class="table" id = "tables">
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center><a href="bookdetails.php?uid=<?=$uId?>&id=<?php echo $bookid; ?>" class="btn btn-primary">Details</a>
                                      	<?php
                                      	if($avail > 0)
                                      		echo "<a href=\"issue_request.php?uid=".$uId."&id=".$bookid."\" class=\"btn btn-success\">Issue</a>";
                                        ?>
                                        </center></td>
                                    </tr>
                               <?php }} ?>
