                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="recommendations.php?uid=<?=$uId?>" method="post">
...
$sql1="insert into LMS.recommendations (Book_Name,Description,UserId) values ('$title','$Description','$userId')"; 
