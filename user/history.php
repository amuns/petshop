        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        <form class="form-horizontal row-fluid" action="history.php?uid=<?=$uId?>" method="post">
                                    ...
                                    if(isset($_POST['submit']))
                                        {$s=$_POST['title'];
                                            $sql="select * from LMS.record,LMS.book where UserId = '$userId' and Date_of_Issue is NOT NULL and Date_of_Return is NOT NULL
                                             and book.Bookid = record.BookId and (record.BookId='$s' or Title like '%$s%')";
                                        }
                                    else
                                        $sql="select * from LMS.record,LMS.book where UserId = '$userId' and Date_of_Issue is NOT NULL and Date_of_Return is NOT NULL and
                                         book.Bookid = record.BookId";
